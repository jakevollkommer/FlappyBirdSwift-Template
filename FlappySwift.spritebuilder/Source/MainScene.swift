...
//  FlappySwift
//
//  Created by Jake Vollkommer on 9/16/15.
...
class MainScene: GamePlayScene {
    ...
    let firstObstaclesPosition: CGFloat = 200
    ...
    func spawnNewObstacle(){
        var prevObstaclePos = firstObstaclesPosition
    ...
    override func touchBegan(touch: CCTouch!, withEvent event: CCTouchEvent!) {
        if (!isGameOver){
            ...
            //resets the time so that the bird doesn't just rotate immediately after jumping
            sinceTouch = 0;
        }
    }
    ...
    override func update(delta: CCTime) {
        ...
        for obstacle in obstacles.reverse() {
            ...
            //obstacle moved past left side of the screen?
